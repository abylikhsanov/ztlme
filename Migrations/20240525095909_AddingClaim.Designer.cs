...
namespace ztlme.Migrations
{
    ...
    [Migration("20240525095909_AddingClaim")]
    partial class AddingClaim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ztlme.Models.Pool", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("ClaimedThisYear")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("ztlme.Models.UserClaimSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("ClaimCurrentYear")
                        .HasColumnType("double precision");

                    b.Property<double>("UserClaimTotal")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("ztlme.Models.UserContributionSummary", b =>
                {
                    ...
                    b.ToTable("UserContributionSummaries");
                });
            ...
            modelBuilder.Entity("ztlme.Models.UserClaimSummary", b =>
                {
                    b.HasOne("User", "User")
                        .WithOne("UserClaimSummary")
                        .HasForeignKey("ztlme.Models.UserClaimSummary", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
